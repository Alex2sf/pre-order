<x-owner-layout title="Detail Pesanan" :header="'📋 ' . $order->invoice_number" :subtitle="'Detail pesanan dari ' . $order->customer_name">
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
                ...
                <div class="flex items-center justify-between p-4 rounded-xl bg-slate-50 mb-3">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <form method="POST" action="{{ route('owner.payments.verify', $payment) }}">
                            @csrf
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
                ...
                <form method="POST" action="{{ route('owner.orders.status', $order) }}" class="space-y-3">
                    @csrf @method('PATCH')
