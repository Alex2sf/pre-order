<x-owner-layout title="Pesanan" :header="'🛒 Daftar Pesanan'" :subtitle="'Kelola semua pesanan pre-order'">
    {{-- Filters --}}
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    <tr class="hover:bg-slate-50/50 transition">
                        ...
                        <td class="px-6 py-3">
                            <a href="{{ route('owner.orders.show', $order) }}" class="px-3 py-1.5 bg-violet-50 text-violet-700 rounded-lg text-xs font-semibold hover:bg-violet-100 transition">Detail</a>
                        </td>
                    </tr>
                    @empty
                    <tr>
